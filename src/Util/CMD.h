...
namespace toolkit
{
    ...
    class Option
    {
      public:
        ...
        Option(char short_opt, const char* long_opt, enum ArgType type, const char* default_value, bool must_exist, const char* des, const OptionHandler& cb)
        {
    ...
    class OptionParser
    {
      public:
        ...
        OptionParser(const OptionCompleted& cb = nullptr, bool enable_empty_args = true)
        {
            ...
            _helper            = Option('h', "help", Option::ArgNone, nullptr, false, "打印此信息", [this](const std::shared_ptr<std::ostream>& stream, const std::string& arg) -> bool
                             {
